""" Thanks to the original authors of this file
...
def load_and_prepare_data(args):
    ...
    if args.TRAIN_DATASET=='pascal':
        ...
        data_dir = f'{args.DATA_ROOT_DIR}/SPair-71k'
