...
def generate_potential_push_poses_for_surface(
    ...
    # 1) only consider vertices that are aligned with push_direction
    angle_err = 20
    while True:
        angle_degrees = geom_utils.calculate_angle(surface_vert_normals, -push_direction)
