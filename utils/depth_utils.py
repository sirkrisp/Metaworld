...
def pixel_coords_to_world_coords(T_pixel2world: np.ndarray, real_depth: np.ndarray, pixel_coords_xy: Optional[np.ndarray] = None, return_adjusted_pixel_coords_xy=False) -> np.ndarray:
    """
    Convert image coordinates to world coordinates.
...
def world_coords_to_depth(T_world2pixel: np.ndarray, world_coords: np.ndarray):
    """
    Convert world coordinates to depth
...
def pixel_coords_to_depth(real_depth: np.ndarray, pixel_coords_xy: np.ndarray):
    """
    Convert image coordinates to world coordinates.
